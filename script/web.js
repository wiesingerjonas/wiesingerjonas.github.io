window.addEventListener('load', () => {
  const web =
    ...
    '{"title":"Vs Hart", "iframe":"null", "pic":"null", "text":"I am currently working on a web project with two classmembers. We are renewing the Webpage of the Vs Hart. Unfortunately, the project is delayed due to the global pandemic and the school closure."},' +
